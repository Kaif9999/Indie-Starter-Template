...
export const plans = [
    {
        link:
            process.env.NODE_ENV === "development"
                ? "https://buy.stripe.com/test_6oU4gA3Ph9L3gGHeZs5kk00"
                : "",
        priceId:
            process.env.NODE_ENV === "development"
                ? "prod_SRaGcVoNN8LUBv"
    ...
    },   
    {
        link:
            process.env.NODE_ENV === "development"
                ? "https://buy.stripe.com/test_fZu00k2Ld1exgGH7x05kk01"
                : "",
        priceId:
            process.env.NODE_ENV === "development"
                ? "prod_SRaGcVoNN8LUBv"
...
export default function Pricing() {
    ...
    const getYearlyMonthlyPrice = () => {
        if (billingInterval === "yearly") {
            return Math.round((currentPlan?.price || 99) / 12)
        }
        return currentPlan?.price || 10
    }
    ...
    const getUpgradeUrl = () => {
        ...
        // Fallback to dodo payments if no Stripe link
        return "https://checkout.dodopayments.com/buy/pdt_17wlMmBaE7Klqk5QnB0Up?quantity=1&redirect_url=https://anilyst.tech%2Fmain%2F"
    }

    const handleLifetimeSubscription = () => {
        setIsLoading(true)
        window.location.href =
            "https://checkout.dodopayments.com/buy/pdt_6iGXPJ0iAZjGLv0lINYR4?quantity=1&redirect_url=https://anilyst.tech%2Fmain%2F"
    }
    ...
    return (
        <div className="relative min-h-screen bg-black overflow-hidden">
            <div className="relative z-10 container mx-auto px-4 py-24">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold mb-6 py-16 pb-4 text-white">
                        Plans & Pricing
                    </h1>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span className="text-purple-300 tracking-wide">
                                            Save $
                                            {(plans[0].price * 12) - plans[1].price}
                                        </span>
                                    </motion.div>
                                </label>
                            </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="text-gray-300">
                                    {billingInterval === "yearly" ? (
                                        <>
                                            <span className="text-green-400">${currentPlan?.price}/year</span>
                                            <span className="block text-sm text-gray-400 mt-1">
                                                Save $
                                                {(plans[0].price * 12) - (currentPlan?.price || 99)} (Billed yearly)
                                            </span>
                                        </>
                                    ) : (
                            ...
                            <Link
                                ...
                                className="w-full inline-flex justify-center items-center py-3 px-4 rounded-xl bg-white text-black hover:bg-white/90 transition-colors mb-8 text-center"
                            >
                    ...
                    >
                        ...
                        <p className="text-gray-300 mb-6">Buy once, use forever</p>
                        <div className="mb-6">
                            <motion.div
                                className="text-4xl font-bold text-white"
                                initial={false}
                            ...
                            >
                                $250
                                <span className="text-lg font-normal text-gray-400">/lifetime</span>
                            </motion.div>
